...
- [x] Keep the `ci_smoke` sketch (`examples/ci_smoke`, `smoke_hal.h`) since GitHub Actions still compiles it directly and it is currently green.
...
- Fixed the `ci_smoke` preprocessor warning.
